...
function user_input() {
    ...
    if ( keyboard.pressed("w") ) {  // forward
        ...
        robot.control.xyz[2] += 0.1 * robot.dir.header[2][0];
        robot.control.xyz[0] += 0.1 * robot.dir.header[0][0];
    }
    ...
    if ( keyboard.pressed("q") ) {  // strafe
        ...
        robot.control.xyz[2] += 0.1 * robot.dir.lateral[2][0];
        robot.control.xyz[0] += 0.1 * robot.dir.lateral[0][0];
    }
